...
let splatTextureMaterialAdditive;
let quadPlaneMesh;
let particlesMesh;
function initMaterials() {
    ...
    splatTextureMaterialAdditive = new THREE.ShaderMaterial( {
        uniforms: {
            uTexture: { type: "t", value: null },
        },
        vertexShader: splatTextureVert, 
...
function step(dt, now) {
    ...
    splatTextureMaterialAdditive.uniforms.uTexture.value = window.fluidSimDyeFBO.read.texture;
    quadPlaneMesh.material = splatTextureMaterialAdditive;
    renderer.setRenderTarget(trailMap.write);
    ...
    quadPlaneMesh.material = displayPass;
    displayPass.uniforms.dt.value               = dt;
    // displayPass.uniforms.uTrailMap.value        = window.fluidSimVelocityFBO.read.texture;//;trailMap.read.texture;
    displayPass.uniforms.uTrailMap.value        = trailMap.read.texture;
